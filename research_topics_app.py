...
# =========================
# Two-column layout: Explorer (left) + Chat (right)
# =========================
col_main, col_chat = st.columns([3, 1.3])

with col_chat:
    st.markdown("&nbsp;", unsafe_allow_html=True)  # small spacer to align with tabs
    ...
    components.html(f"""
    <style>
      @import url('https://fonts.googleapis.com/css2?family=Oswald:wght@600&family=Zilla+Slab:wght@300&display=swap');
    ...
    <div class="chat-wrapper">
      <div class="chat-header">
        ...
        <div class="subtitle">Ask about faculty expertise &amp; research</div>
      </div>
      <div class="chat-body">
